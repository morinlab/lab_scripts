...
def main():
	...
	parser_filter.add_argument('-header', '--header_row', nargs=1, type=int, default=[0], help='If your input file has a differenet header index, pass it here')
	...
	if args.subcommand == 'filecompare': 
		...
		intersect = InBoth(input_maf_1,input_maf_2)
